...
export function SearchPropertyResult({
  ...
  const MAX_PAGE = Math.ceil(Number(data?.count) / searchParams.pageSize);
        ...
        <PaginationContent>
          <PaginationItem>
            <Link
              ...
              search={(s) => ({ ...s, page: s.page ? s.page - 1 : 1 })}
              to="."
            >
              <PaginationPrevious />
            </Link>
          ...
          <PaginationItem>
            <Link
              className="aria-disabled:pointer-events-none aria-disabled:opacity-50"
              disabled={searchParams.page >= MAX_PAGE}
              search={(s) => ({ ...s, page: s.page ? s.page + 1 : MAX_PAGE })}
              to="."
            >
              <PaginationNext />
            </Link>
