        ...
        <Item className="p-0">
          ...
          <ItemContent>
            <Button
              ...
              nativeButton={false}
              render={
                <Link params={params} to="/$organizationId/property">
...
const PropertyGrid = ({ organizationId }: { organizationId: string }) => {
  ...
  return (
    <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4 lg:gap-4">
      {properties.length < 1 ? (
        <Card className="group relative w-full min-w-36 pt-0 transition-shadow hover:shadow-3xl">
          <CardContent>
            <Empty>
              <EmptyHeader>
          ...
          <CardFooter className="flex flex-col gap-2">
            <Button
              ...
              nativeButton={false}
              render={
                <Link params={params} to="/$organizationId/property/create">
            ...
            <Button
              ...
              nativeButton={false}
              render={
                <Link params={params} to="/$organizationId/property/import">
