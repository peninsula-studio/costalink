...
export const kyeroImage = z.object({
  id: z.string(),
  url: z.url(), // Enforces valid URL format
});

export const kyeroSurfaceArea = z.object({
  built: z.number().optional(),
  plot: z.number().optional(),
});

export const kyeroEnergyRating = z.object({
...
export const kyeroProperty = z.object({
  // -- Mandatory Fields --
  // id: z.string(),
  ...
  surface_area: kyeroSurfaceArea.optional(),
  energy_rating: kyeroEnergyRating.optional(),
...
export const kyeroFeed = z.object({
  root: z.object({
    kyero: z.object({
      feed_version: z.string().optional(),
    }),
    property: z.array(kyeroProperty),
  }),
});
